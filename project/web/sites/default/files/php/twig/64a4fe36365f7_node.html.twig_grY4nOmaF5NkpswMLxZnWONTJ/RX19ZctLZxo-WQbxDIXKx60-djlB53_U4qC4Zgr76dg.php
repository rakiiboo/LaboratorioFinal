...
/* themes/custom/proyectoFinal/templates/content/node.html.twig */
class __TwigTemplate_d5e0db67cd6d216bdff63151a73fcec6 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("lab3/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/custom/proyectoFinal/templates/content/node.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/proyectoFinal/templates/content/node.html.twig", "/var/www/html/web/themes/custom/proyectoFinal/templates/content/node.html.twig");
    }
